...
void runLCD()
{
	...
	while(nLCDButtons != centerButton)
	{
		...
		case 0:
			...
			displayLCDCenteredString(0, "Right 8 Point");
		...
		case 1:
			...
			displayLCDCenteredString(0, "Left 8 Point");
			displayLCDCenteredString(1, "<         Enter        >");
			waitForPress();
			//Increment or decrement "count" based on button press
			if(nLCDButtons == leftButton)
		...
		case 2:
			...
			displayLCDCenteredString(0, "Right 12 Point");
			displayLCDCenteredString(1, "<         Enter        >");
			waitForPress();
			//Increment or decrement "count" based on button press
			if(nLCDButtons == leftButton)
		...
		case 3:
			...
			displayLCDCenteredString(0, "Left 12 Point");
			displayLCDCenteredString(1, "<         Enter        >");
			waitForPress();
			//Increment or decrement "count" based on button press
			if(nLCDButtons == leftButton)
